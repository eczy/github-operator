...
func init() {
	...
	utilruntime.Must(githuboperatoreczyiov1.AddToScheme(scheme))
...
func main() {
	...
	flag.BoolVar(&propagateDeletes, "propagate-deletes", false,
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "aac97e23.github-operator.eczy.io",
	...
	if err := (&controller.BranchProtectionRuleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BranchProtectionRule")
		os.Exit(1)
	}
