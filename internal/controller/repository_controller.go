...
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=repositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=repositories/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=repositories/finalizers,verbs=update
...
func (r *RepositoryReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&githuboperatoreczyiov1.Repository{}).
		Named("repository").
		Complete(r)
}
