...
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=organizations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=organizations/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=organizations/finalizers,verbs=update
...
func (r *OrganizationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&githuboperatoreczyiov1.Organization{}).
		Named("organization").
		Complete(r)
}
