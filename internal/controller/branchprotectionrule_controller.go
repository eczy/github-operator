...
var (
	branchProtectionFinalizerName = "github-operator.eczy.io/branch-protection-finalizer"
)
...
// BranchProtectionRuleReconciler reconciles a BranchProtectionRule object
type BranchProtectionRuleReconciler struct {
	client.Client
...
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=branchprotectionrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=branchprotectionrules/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=github-operator.eczy.io,resources=branchprotectionrules/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the BranchProtectionRule object against the actual cluster state, and then
...
func (r *BranchProtectionRuleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// fetch resource
	bp := &githuboperatoreczyiov1.BranchProtectionRule{}
...
func (r *BranchProtectionRuleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&githuboperatoreczyiov1.BranchProtectionRule{}).
		Named("branchprotectionrule").
		Complete(r)
}

func (r *BranchProtectionRuleReconciler) createBranchProtection(ctx context.Context, bp *githuboperatoreczyiov1.BranchProtectionRule) (*gh.BranchProtection, error) {
...
func (r *BranchProtectionRuleReconciler) updateBranchProtection(ctx context.Context, bp *githuboperatoreczyiov1.BranchProtectionRule, ghBp *gh.BranchProtection) error {
	...
	if needsUpdate || bp.Status.LastUpdateTimestamp == nil {
		...
		bp.Status = githuboperatoreczyiov1.BranchProtectionRuleStatus{
...
func (r *BranchProtectionRuleReconciler) deleteBranchProtection(ctx context.Context, bp *githuboperatoreczyiov1.BranchProtectionRule) error {
	if bp.Status.NodeId == nil {
...
func (r *BranchProtectionRuleReconciler) branchProtectionToCreateInput(ctx context.Context, bp *githuboperatoreczyiov1.BranchProtectionRule) (*githubv4.CreateBranchProtectionRuleInput, error) {
	var id githubv4.ID
